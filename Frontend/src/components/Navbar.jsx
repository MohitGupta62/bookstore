    ...
    <>
      <div
        className={`dark:bg-slate-900 dark:text-white max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
          sticky
            ? "sticky-navbar bg-base-200 duration-300 transition-all ease-in-out dark:bg-slate-600"
            : ""
        }`}
      >
        {/* fixed top-0 left-0 right-0 - nav bar ko fix karne ke liye use kiya hai */}
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-medium cursor-pointer">Book Store</a>
          </div>
